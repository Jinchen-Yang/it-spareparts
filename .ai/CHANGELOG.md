...
## 2026-09-20 — v1.36.0 维保人工维护与页面批量（Release Candidate，待 CI 与生产验收）
...
**验证:** 专项与隔离真实页面验收已执行；完整前端回归发现的旧版本断言和异步定位问题正在收口。最终 Required CI、生产迁移、登录验收、部署时间与 SHA 由发布后据实补录，未完成项不视为通过。
