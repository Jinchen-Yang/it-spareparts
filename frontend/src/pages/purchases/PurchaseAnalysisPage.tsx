...
import { Card, Checkbox, Grid, List, Segmented, Table, Tag, Tooltip, theme, message } from "antd";
...
// 逐笔比价下钻（桌面展开行用）。数据源 fetchPurchaseDrill 原样复用。
      ...
      <Card>
        ...
        {isMobile ? (
          <List
            ...
            renderItem={(r) => (
              <List.Item key={r.part_id} onClick={() => setDetail(r)} style={{ cursor: "pointer" }}>
                <div style={{ width: "100%" }}>
