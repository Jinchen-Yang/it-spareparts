...
const project = {
  ...
  metrics: {
    ...
    site_requisition_known_cost_ex_tax: 265.49,
    site_requisition_known_cost_inc_tax: 300,
    approved_expense: 100,
    approved_expense_ex_tax: 88.5,
    approved_expense_inc_tax: 100,
    actual_project_cost_known: 400,
    actual_project_cost_known_ex_tax: 353.99,
    actual_project_cost_known_inc_tax: 400,
