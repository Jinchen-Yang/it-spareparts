    ...
    if (get_settings().maintenance_project_master_v2_enabled
        ...
        return {
            ...
            "rows": [{
                ...
                "cost_source": "manual" if (line.unit_cost_ex_tax is None and line.id in overrides) else (line.cost_source or "none"),
                "cost_source_label": "人工回填" if (line.unit_cost_ex_tax is None and line.id in overrides) else (line.cost_source or "无成本结果"),
