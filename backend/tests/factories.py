...
def sales_head(order_raw_id: str, order_no: str | None = None,
               on: date | None = None, business_type="备件销售", data_status="已生效",
               amount_ex_tax=None, tax_rate=None) -> dict:
    return {
        "raw_order_id": order_raw_id, "order_no": order_no or order_raw_id,
        "order_date": on or date(2026, 2, 1), "tax_rate": tax_rate, "amount_ex_tax": amount_ex_tax,
